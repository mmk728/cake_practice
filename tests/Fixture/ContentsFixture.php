...
class ContentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'subject' => ['type' => 'string', 'length' => 15, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'text_body' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
        ...
        '_constraints' => [
            ...
            'contents_ibfk_1' => ['type' => 'foreign', 'columns' => ['thread_id'], 'references' => ['threads', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'contents_ibfk_2' => ['type' => 'foreign', 'columns' => ['account_id'], 'references' => ['accounts', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
