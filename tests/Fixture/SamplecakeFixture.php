 ...
 * SamplecakeFixture
 */
class SamplecakeFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'address' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
