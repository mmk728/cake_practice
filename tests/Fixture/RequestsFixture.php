...
class RequestsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'customer_key' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'customer_id' => 1,
                'created' => '2019-11-14 07:31:50',
                'modified' => '2019-11-14 07:31:50'
            ],
        ];
        parent::init();
    }
